...
def save_results(args, test_results):
    ...
    var = [args.dataset, args.num_labeled_classes, args.num_unlabeled_classes, args.batch_size, args.max_epochs, args.seed, args.IND_class, args.OOD_class]
    names = ['dataset', 'num_labeled_classes', 'num_unlabeled_classes', 'batch_size', 'max_epochs', 'seed', 'IND_class', 'OOD_class']
    vars_dict = {k: v for k, v in zip(names, var)}
    results = dict(test_results, **vars_dict)
    keys = list(results.keys())
    values = list(results.values())

    file_name = 'results_main_cross_new_v1.csv'
...
def main(args):
    ...
    root_path = "/home1/myt2021/Research/OOD/UNO-intent/UNO_checkpoints_cross/OOD_" + str(
        args.num_unlabeled_classes)+"/v2"
    #root_path = "/home1/myt2021/Research/OOD/UNO-intent/UNO_checkpoints_cross/OOD_" + str(
    #    args.num_unlabeled_classes)+"/v1"
    print(root_path)
    ...
    #root_path = "/home1/myt2021/Research/OOD/UNO-intent/UNO_checkpoints_cross/OOD_"+str(args.num_unlabeled_classes)+"/travel"
    for filename in os.listdir(root_path):
        best_path = os.path.join(root_path, "epoch=123-step=4463.ckpt")
    print(best_path)
    test_model = Discoverer.load_from_checkpoint(checkpoint_path=best_path)
