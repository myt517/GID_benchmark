...
parser.add_argument("--save_results_path", type=str, default='outputs_v2', help="The path to save results.")
...
class Discoverer(pl.LightningModule):
    ...
    def validation_epoch_end(self, _):
        ...
        best_head = results_inc[2]["acc"].index(max(results_inc[2]["acc"]))
        self.best_head = best_head
        val_acc = results_inc[2]["acc"][best_head]
        # log
        val_results = {
...
def save_results(args, test_results):
    ...
    file_name = 'results_main_5_v2.csv'
...
def main(args):
    ...
    root_path = "/home1/myt2021/Research/OOD/UNO-intent/UNO_checkpoints/OOD_" + str(
        args.num_unlabeled_classes) + "_seed50"
    print(root_path)
    ...
    for filename in os.listdir(root_path):
        best_path = os.path.join(root_path, filename)
    print(best_path)
