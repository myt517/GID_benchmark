...
parser.add_argument("--save_results_path", type=str, default='outputs_v3', help="The path to save results.")
...
def save_results(args, test_results):
    ...
    file_name = 'results_imbalanced_t1.csv'
...
def main(args):
    ...
    root_path = "/home1/myt2021/Research/OOD/UNO-intent/UNO_checkpoints_imbalanced_t1/OOD_" + str(
        args.num_unlabeled_classes) + "_seed20"
    print(root_path)
